...
public class Application {
    ...
    public CommandLineRunner demoSave(CustomerRepository repository) {
        return (args) -> {
            log.info("┌───────── Save:");
            log.info("│ {}",repository.save(new Customer().setFirstName("Jack").setLastName("Bauer")));
            log.info("│ {}",repository.save(new Customer().setFirstName("Chloe").setLastName("O'Brian")));
            log.info("│ {}",repository.save(new Customer().setFirstName("Kim").setLastName("Bauer")));
            log.info("│ {}",repository.save(new Customer().setFirstName("David").setLastName("Palmer")));
            log.info("│ {}",repository.save(new Customer().setFirstName("Michelle").setLastName("Dessler")));
            log.info("└──────────────────────────────────────────");
        };
    }
